...
<div id="mainContainer">
  ...
  <cr-infinite-list id="downloadsList" role="grid" aria-rowcount="25"><template shadowrootmode="open"><!----><slot></slot></template>
  <!----><cr-lazy-list id="list" chunk-size="0" style="--chunk-size: 0;"><template shadowrootmode="open"><!----><div id="container" style="height: 2665.28px;"><slot id="slot"></slot></div></template>
        <!----><!---->
  ...
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="primitive_to_wrapper_class.java" tabindex="-1" role="link" hidden=""><!-- No line break
          --><!--?lit$333633370$-->primitive_to_wrapper_class.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="primitive_to_wrapper_class.java"><!-- No line break
...
<div id="content" focus-row-container="" class="is-active focus-row-active">
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/29d3f985-9266-4c82-a90d-97fd336bc911" title="wrapper  object (1).java" tabindex="0" role="link"><!-- No line break
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/29d3f985-9266-4c82-a90d-97fd336bc911" tabindex="0"><!--?lit$333633370$-->blob:https://github.com/29d3f985-9266-4c82-a90d-97fd336bc911</a>
      </div>

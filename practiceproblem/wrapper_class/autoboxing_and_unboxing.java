...
<div id="leftContent">
  <div id="leftSpacer">
    ...
    <h1><!--?lit$333633370$-->Download history</h1>
  </div>
</div>
 ...
 <g>
  ...
  <div id="searchTerm">
    <label id="prompt" for="searchInput" aria-hidden="true">
      <!--?lit$333633370$-->Search download history
    </label>
...
<div id="mainContainer">
  <managed-footnote managed-by-icon_=""><template shadowrootmode="open"><!----><!--?lit$333633370$--><!--?--></template></managed-footnote>
  <cr-infinite-list id="downloadsList" role="grid" aria-rowcount="21"><template shadowrootmode="open"><!----><slot></slot></template>
  <!----><cr-lazy-list id="list" chunk-size="0" style="--chunk-size: 0;"><template shadowrootmode="open"><!----><div id="container" style="height: 2307.67px;"><slot id="slot"></slot></div></template>
        <!----><!---->
...
<div id="date" role="heading" aria-level="2"><!--?lit$333633370$-->Today</div>
...
<div id="content" focus-row-container="" class="is-active show-progress">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDesktop%5Cwrapper_class%5Cautoboxing_and_unboxing.java&amp;scale=1.5x">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="autoboxing_and_unboxing.java" tabindex="-1" role="link" hidden=""><!-- No line break
          --><!--?lit$333633370$-->autoboxing_and_unboxing.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="autoboxing_and_unboxing.java"><!-- No line break
          --><!--?lit$333633370$-->autoboxing_and_unboxing.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="chrome://downloads/" tabindex="-1"><!--?lit$333633370$-->chrome://downloads</a>
      </div>

      <div class="description" role="gridcell" description-color="">
        <!--?lit$333633370$-->0 B/s - 0 B
      </div>
...
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="quick-show-in-folder" class="icon-folder-open" focus-row-control="" focus-type="quickShow" title="Show in folder" aria-label="Show in folder" role="button" tabindex="-1" aria-disabled="false" hidden=""><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
        </cr-icon-button>
...
<div id="date" role="heading" aria-level="2"><!--?lit$333633370$--></div>

<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cwrappewr+to+primitive+%281%29.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/64ce46a9-e4a5-436b-901e-2d3774de77b3" title="wrappewr to primitive (1).java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->wrappewr to primitive (1).java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="wrappewr to primitive (1).java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->wrappewr to primitive (1).java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>

      <div role="gridcell">
        <div id="initiator-origin">
          <!--?lit$333633370$-->From https://github.com
        </div>
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/64ce46a9-e4a5-436b-901e-2d3774de77b3" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/64ce46a9-e4a5-436b-901e-2d3774de77b3</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cwrapper+comparison+%281%29.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/d8f9806b-24ec-4ee9-a360-d130a1c1285f" title="wrapper comparison (1).java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->wrapper comparison (1).java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="wrapper comparison (1).java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->wrapper comparison (1).java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/d8f9806b-24ec-4ee9-a360-d130a1c1285f" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/d8f9806b-24ec-4ee9-a360-d130a1c1285f</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cwrapper++object+%281%29.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/29d3f985-9266-4c82-a90d-97fd336bc911" title="wrapper  object (1).java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->wrapper  object (1).java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="wrapper  object (1).java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->wrapper  object (1).java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/29d3f985-9266-4c82-a90d-97fd336bc911" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/29d3f985-9266-4c82-a90d-97fd336bc911</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cprimitive+to+wrapper+class+%281%29.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/e120e699-5a13-4f2d-8d67-22b19c81c7d2" title="primitive to wrapper class (1).java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->primitive to wrapper class (1).java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="primitive to wrapper class (1).java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->primitive to wrapper class (1).java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/e120e699-5a13-4f2d-8d67-22b19c81c7d2" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/e120e699-5a13-4f2d-8d67-22b19c81c7d2</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cinput+conversion+utility+%281%29.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/e9cfd914-1992-4009-9766-929e4ae94365" title="input conversion utility (1).java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->input conversion utility (1).java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="input conversion utility (1).java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->input conversion utility (1).java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/e9cfd914-1992-4009-9766-929e4ae94365" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/e9cfd914-1992-4009-9766-929e4ae94365</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cclass+utility+wrapper+%281%29.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/29e33405-a679-429f-8553-ada77df465e4" title="class utility wrapper (1).java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->class utility wrapper (1).java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="class utility wrapper (1).java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->class utility wrapper (1).java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/29e33405-a679-429f-8553-ada77df465e4" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/29e33405-a679-429f-8553-ada77df465e4</a>
      </div>
...
<!--_html_template_end_--></template>
        ...
        <downloads-item tabindex="0" aria-rowindex="8" id="frb7" role="row" class="no-outline"><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="date" role="heading" aria-level="2"><!--?lit$333633370$--></div>

<div id="content" focus-row-container="" class="is-active focus-row-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cchr+wrapper+iuse+case+%281%29.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/33be0462-0934-4642-bc4c-72823c883681" title="chr wrapper iuse case (1).java" tabindex="0" role="link"><!-- No line break
          --><!--?lit$333633370$-->chr wrapper iuse case (1).java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="chr wrapper iuse case (1).java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->chr wrapper iuse case (1).java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/33be0462-0934-4642-bc4c-72823c883681" tabindex="0"><!--?lit$333633370$-->blob:https://github.com/33be0462-0934-4642-bc4c-72823c883681</a>
      </div>
...
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none">
 <g>
        ...
        <cr-icon-button id="quick-show-in-folder" class="icon-folder-open" focus-row-control="" focus-type="quickShow" title="Show in folder" aria-label="Show in folder" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template>
        </cr-icon-button>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cautoboxing+and+unboxing+%281%29.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/6fbb91b2-3a23-4591-b4a9-e3ba133c6bb4" title="autoboxing and unboxing (1).java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->autoboxing and unboxing (1).java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="autoboxing and unboxing (1).java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->autoboxing and unboxing (1).java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/6fbb91b2-3a23-4591-b4a9-e3ba133c6bb4" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/6fbb91b2-3a23-4591-b4a9-e3ba133c6bb4</a>
      </div>
...
<div id="date" role="heading" aria-level="2"><!--?lit$333633370$-->October 31, 2025</div>

<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cwrappewr+to+primitive.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/c7cbe912-e787-4da8-8747-b2f82440bfb8" title="wrappewr to primitive.java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->wrappewr to primitive.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="wrappewr to primitive.java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->wrappewr to primitive.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/c7cbe912-e787-4da8-8747-b2f82440bfb8" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/c7cbe912-e787-4da8-8747-b2f82440bfb8</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cwrapper+comparison.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/766bf07d-bfa8-44e0-afc2-c3c71565cf1f" title="wrapper comparison.java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->wrapper comparison.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="wrapper comparison.java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->wrapper comparison.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/766bf07d-bfa8-44e0-afc2-c3c71565cf1f" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/766bf07d-bfa8-44e0-afc2-c3c71565cf1f</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cwrapper++object.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/c588f63a-05e8-4632-837e-47b61afe8f26" title="wrapper  object.java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->wrapper  object.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="wrapper  object.java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->wrapper  object.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/c588f63a-05e8-4632-837e-47b61afe8f26" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/c588f63a-05e8-4632-837e-47b61afe8f26</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cprimitive+to+wrapper+class.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/44cdd68d-bf6b-423d-89c3-126672bec03e" title="primitive to wrapper class.java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->primitive to wrapper class.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="primitive to wrapper class.java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->primitive to wrapper class.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/44cdd68d-bf6b-423d-89c3-126672bec03e" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/44cdd68d-bf6b-423d-89c3-126672bec03e</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cinput+conversion+utility.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/51467508-7d0c-4c52-94c2-5ec5c54f1a51" title="input conversion utility.java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->input conversion utility.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="input conversion utility.java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->input conversion utility.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/51467508-7d0c-4c52-94c2-5ec5c54f1a51" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/51467508-7d0c-4c52-94c2-5ec5c54f1a51</a>
      </div>
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cclass+utility+wrapper.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/a2359e4b-eb1d-4784-89fd-3faa0e69593a" title="class utility wrapper.java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->class utility wrapper.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="class utility wrapper.java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->class utility wrapper.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/a2359e4b-eb1d-4784-89fd-3faa0e69593a" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/a2359e4b-eb1d-4784-89fd-3faa0e69593a</a>
      </div>
...
<!--_html_template_end_--></template>
        ...
        <downloads-item tabindex="-1" aria-rowindex="16" id="frb15" role="row" class="no-outline"><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="date" role="heading" aria-level="2"><!--?lit$333633370$--></div>

<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cchr+wrapper+iuse+case.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/e7ca2a89-a300-47f1-9e6d-d745c12cd73b" title="chr wrapper iuse case.java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->chr wrapper iuse case.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="chr wrapper iuse case.java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->chr wrapper iuse case.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/e7ca2a89-a300-47f1-9e6d-d745c12cd73b" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/e7ca2a89-a300-47f1-9e6d-d745c12cd73b</a>
      </div>
...
<!--_html_template_end_--></template>
        ...
        <downloads-item tabindex="-1" aria-rowindex="17" id="frb16" role="row" class="no-outline"><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="date" role="heading" aria-level="2"><!--?lit$333633370$--></div>

<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDownloads%5Cautoboxing+and+unboxing.java&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/23c5cfce-e015-4c8d-98c4-e0b4b4e6f5b2" title="autoboxing and unboxing.java" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->autoboxing and unboxing.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="autoboxing and unboxing.java" hidden=""><!-- No line break
          --><!--?lit$333633370$-->autoboxing and unboxing.java</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/23c5cfce-e015-4c8d-98c4-e0b4b4e6f5b2" tabindex="-1"><!--?lit$333633370$-->blob:https://github.com/23c5cfce-e015-4c8d-98c4-e0b4b4e6f5b2</a>
      </div>
...
<!--_html_template_end_--></template>
        ...
        <downloads-item tabindex="-1" aria-rowindex="18" id="frb17" role="row" class="no-outline"><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="date" role="heading" aria-level="2"><!--?lit$333633370$-->October 10, 2025</div>

<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    <div id="file-icon-wrapper" class="icon-wrapper" role="img" aria-label="" aria-hidden="true">
      <img class="icon" id="file-icon" alt="" icon-color="" src="chrome://fileicon/?path=C%3A%5CUsers%5CTanya%5CDesktop%5CDefining+and+Implementing+Interfaces+Problem+Statements.pdf&amp;scale=1.5x">
      <cr-icon class="icon" icon-color="" hidden=""><template shadowrootmode="open"><!----></template>
      </cr-icon>
    </div>
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="file:///C:/Users/Tanya/Downloads/Defining%20and%20Implementing%20Interfaces%20Problem%20Statements.pdf" title="Defining and Implementing Interfaces Problem Statements.pdf" tabindex="-1" role="link"><!-- No line break
          --><!--?lit$333633370$-->Defining and Implementing Interfaces Problem Statements.pdf<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="Defining and Implementing Interfaces Problem Statements.pdf" hidden=""><!-- No line break
          --><!--?lit$333633370$-->Defining and Implementing Interfaces Problem Statements.pdf</span>
        <span id="tag"><!--?lit$333633370$--></span>
      </div>
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="file:///C:/Users/Tanya/Downloads/Defining%20and%20Implementing%20Interfaces%20Problem%20Statements.pdf" tabindex="-1"><!--?lit$333633370$-->file:///C:/Users/Tanya/Downloads/Defining%20and%20Implementing%20Interfaces%20Problem%20Statements.pdf</a>
      </div>
...
<!--_html_template_end_--></template>
  ...
  <div id="no-downloads" hidden="">
    <div>
      ...
      <span><!--?lit$333633370$-->Files you download appear here</span>
    </div>
  </div>
</div>

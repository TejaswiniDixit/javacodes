...
<div id="mainContainer">
  ...
  <cr-infinite-list id="downloadsList" role="grid" aria-rowcount="23"><template shadowrootmode="open"><!----><slot></slot></template>
  <!----><cr-lazy-list id="list" chunk-size="0" style="--chunk-size: 0;"><template shadowrootmode="open"><!----><div id="container" style="height: 2452.06px;"><slot id="slot"></slot></div></template>
        <!----><!---->
  ...
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="class_utility_wrapper.java" tabindex="-1" role="link" hidden=""><!-- No line break
          --><!--?lit$333633370$-->class_utility_wrapper.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="class_utility_wrapper.java"><!-- No line break
...
<div id="content" focus-row-container="" class="is-active focus-row-active">
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/e9cfd914-1992-4009-9766-929e4ae94365" title="input conversion utility (1).java" tabindex="0" role="link"><!-- No line break
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/e9cfd914-1992-4009-9766-929e4ae94365" tabindex="0"><!--?lit$333633370$-->blob:https://github.com/e9cfd914-1992-4009-9766-929e4ae94365</a>
      </div>

...
<div id="mainContainer">
  ...
  <!----><cr-lazy-list id="list" chunk-size="0" style="--chunk-size: 0;"><template shadowrootmode="open"><!----><div id="container" style="height: 2676px;"><slot id="slot"></slot></div></template>
        <!----><!---->
  ...
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="lightaction.java" tabindex="-1" role="link" hidden=""><!-- No line break
          --><!--?lit$220612451$-->lightaction.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="lightaction.java"><!-- No line break
...
<div id="content" focus-row-container="" class="is-active">
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/0823b98b-f5d7-4ab3-bc1d-3548e172c3db" title="Product1.java" tabindex="-1" role="link" class=""><!-- No line break
          --><!--?lit$220612451$-->Product1.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="Product1.java" hidden=""><!-- No line break
...
<!--_html_template_end_--></template>
        ...
        <downloads-item tabindex="0" aria-rowindex="7" id="frb6" role="row" class="no-outline"><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="date" role="heading" aria-level="2"><!--?lit$220612451$--></div>
...
<div id="content" focus-row-container="" class="is-active focus-row-active">
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/f77cfd23-f61a-4fdc-bd0a-ba70f5f7a7bd" title="NotificationFilter.java" tabindex="0" role="link"><!-- No line break
          --><!--?lit$220612451$-->NotificationFilter.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="NotificationFilter.java" hidden=""><!-- No line break
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/f77cfd23-f61a-4fdc-bd0a-ba70f5f7a7bd" tabindex="0"><!--?lit$220612451$-->blob:https://github.com/f77cfd23-f61a-4fdc-bd0a-ba70f5f7a7bd</a>
      </div>

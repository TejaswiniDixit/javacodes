...
<div id="mainContainer">
  ...
  <!----><cr-lazy-list id="list" chunk-size="0" style="--chunk-size: 0;"><template shadowrootmode="open"><!----><div id="container" style="height: 2611.71px;"><slot id="slot"></slot></div></template>
        <!----><!---->
  ...
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="patient_ids.java" tabindex="-1" role="link" hidden=""><!-- No line break
          --><!--?lit$220612451$-->patient_ids.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="patient_ids.java"><!-- No line break
...
<div id="content" focus-row-container="" class="is-active focus-row-active">
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/0823b98b-f5d7-4ab3-bc1d-3548e172c3db" title="Product1.java" tabindex="0" role="link"><!-- No line break
          --><!--?lit$220612451$-->Product1.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="Product1.java" hidden=""><!-- No line break
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/0823b98b-f5d7-4ab3-bc1d-3548e172c3db" tabindex="0"><!--?lit$220612451$-->blob:https://github.com/0823b98b-f5d7-4ab3-bc1d-3548e172c3db</a>
      </div>

...
<div id="mainContainer">
  ...
  <!----><cr-lazy-list id="list" chunk-size="0" style="--chunk-size: 0;"><template shadowrootmode="open"><!----><div id="container" style="height: 2642.12px;"><slot id="slot"></slot></div></template>
        <!----><!---->
  ...
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="notificationfilter.java" tabindex="-1" role="link" hidden=""><!-- No line break
          --><!--?lit$220612451$-->notificationfilter.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="notificationfilter.java"><!-- No line break
...
<!--_html_template_end_--></template>
        ...
        <downloads-item tabindex="0" aria-rowindex="5" id="frb4" role="row" class="no-outline"><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="date" role="heading" aria-level="2"><!--?lit$220612451$--></div>
...
<div id="content" focus-row-container="" class="is-active focus-row-active">
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        Can't have any line breaks.
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="blob:https://github.com/10f80253-665b-4aea-979e-4e38ff21c9d6" title="PatientIDs.java" tabindex="0" role="link" class=""><!-- No line break
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="blob:https://github.com/10f80253-665b-4aea-979e-4e38ff21c9d6" tabindex="0"><!--?lit$220612451$-->blob:https://github.com/10f80253-665b-4aea-979e-4e38ff21c9d6</a>
      </div>

...
<div id="mainContainer">
  ...
  <!----><cr-lazy-list id="list" chunk-size="0" style="--chunk-size: 0;"><template shadowrootmode="open"><!----><div id="container" style="height: 2553px;"><slot id="slot"></slot></div></template>
        <!----><!---->
  ...
  <div id="main-content">
    ...
    <div id="details">
      <div id="title-area" role="gridcell"><!--
        ...
        --><a is="action-link" id="file-link" focus-row-control="" focus-type="fileLink" href="chrome://downloads/" title="product1.java" tabindex="0" role="link" hidden=""><!-- No line break
          --><!--?lit$220612451$-->product1.java<!-- No line break
        --></a><!--
        Before #name.
        --><span id="name" title="product1.java"><!-- No line break
      ...
      <div role="gridcell">
        ...
        <a id="url" target="_blank" focus-row-control="" focus-type="url" hidden="" href="chrome://downloads/" tabindex="0"><!--?lit$220612451$-->chrome://downloads</a>
      </div>
